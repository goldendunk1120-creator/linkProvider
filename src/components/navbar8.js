      ...
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a onClick={() => scrollToSection('features') } className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text14">Features</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text20">Pricing</span>
                </Fragment>
              )}
            </a>
            <div
              onClick={() => scrollToSection('testnominal')}
              className="navbar8-link4-dropdown-trigger"
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text13">Testimonials</span>
                  </Fragment>
                )}
              </span>
            </div>
                      ...
                      <div className="navbar8-menu-item1">
                        ...
                        <div className="navbar8-content1">
                          <span className="navbar8-page11 thq-body-large">
                            {props.page1 ?? (
                              <Fragment>
                                <span className="navbar8-text22">Page One</span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text19">Page Two</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
            ...
            <div className="navbar8-buttons2">
              ...
              <button className="thq-button-outline">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar8-text18">Secondary Action</span>
                    </Fragment>
                  )}
                </span>
              </button>
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text24">Page Four</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1600728619239-d2a73f7aa541?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NzA0MjcwNHw&ixlib=rb-4.1.0&q=80&w=1080',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1687720657052-c026be7f388c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NzA0MjcwM3w&ixlib=rb-4.1.0&q=80&w=1080',
  page4Description: undefined,
  link1Url: 'https://www.teleporthq.io',
  action2: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1683710806810-02a3bb540718?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NzA0MjcwNXw&ixlib=rb-4.1.0&q=80&w=1080',
  page2: undefined,
  logoAlt: 'logo',
  link3: undefined,
  action1: undefined,
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1648516036396-7398cfea810f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NzA0MjcwNHw&ixlib=rb-4.1.0&q=80&w=1080',
  rootClassName: '',
}
